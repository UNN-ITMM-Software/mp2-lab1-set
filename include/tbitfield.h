...
{
private:
  int  BitLen; // длина битового поля - макс. к-во битов - Юниверс, сколько всего элементов
  TELEM *pMem; // память для представления битового поля
  int  MemLen; // к-во эл-тов Мем для представления бит.поля - Сколько элементов нужно, чтобы представить bitlen элементов 
